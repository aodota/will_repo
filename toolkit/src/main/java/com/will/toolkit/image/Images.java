package com.will.toolkit.image;


import com.will.toolkit.codec.Base64;
import com.will.toolkit.file.Files;
...
public class Images {
    ...
    public static BufferedImage rotate(String srcPath, String taPath, int degree)
        ...
        if (null == srcIm)
            throw ExceptionUtil.makeThrow("Fail to find image file '%s'!", srcPath);
    ...
    public static BufferedImage read(Object img) {
        try {
            ...
            throw ExceptionUtil.makeThrow("Unkown img info!! --> " + img);
        } catch (IOException e) {
            try {
                InputStream in = null;
                if (img instanceof File)
