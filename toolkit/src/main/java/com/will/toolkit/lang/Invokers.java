...
public class Invokers {
     ...
     * @param args 方法参数
     * @return 执行结果
     * @throws NoSuchMethodException 如果没有相应的方法
     */
     ...
     * 
     * @param superClass 接口类
     * @param hostClass 宿主类
     * @param methodName 宿主方法名（可选）
     * @param hostMethodParameterTypes 宿主方法参数（可选）
     * @param hostMethodReturnType 宿主方法返回类型（可选）
     * @return 代理实例
     */
    @SuppressWarnings("unchecked")
    public static <T> T newInvoker(Class<T> superClass, Class<?> hostClass, String methodName,
            Class<?>[] hostMethodParameterTypes, Class<?> hostMethodReturnType) {
        try {
                ...
                for (Method method : methods) {
                    ...
                    if (hostMethodParameterTypes != null
                        ...
                        throw new IllegalArgumentException(String.format(
                                "The host method parameter types'number should be %d", parameterTypes.length - 1));
                    }
